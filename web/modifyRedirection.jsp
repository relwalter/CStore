...
<%
    ...
    try{
        String username=session.getAttribute("modifying").toString();
        System.out.println(username+"  "+session.getAttribute("modified"));
        if(session.getAttribute("username")!=null&&session.getAttribute("modified").equals(true)){
            success=true;
            msg="修改成功！";
            pageInfo="首页";
            dir="Manage.jsp";
...
<body>
 <form id="login">
    ...
    <a href="Index.jsp" id="back" style="font-size:12px;letter-spacing:1px">返回主页...</a>
    </form>
