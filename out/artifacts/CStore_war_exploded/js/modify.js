// JavaScript Document
    ...
    function checkNPass(){
        var userOPass = document.getElementsByName("password")[0].value;
        var userPass = document.getElementsByName("passwordn")[0].value;
        var pts = document.getElementById("passnts");
        // if(userPass.length==0){
        //     pts.innerHTML ="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*请输入密码!";
        //     valid[1]=false;
        //     return false;
        // }
        if(userPass==userOPass){
            pts.innerHTML ="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*不能和原密码相同!";
            valid[1]=false;
            return false;
        }
        if(userPass.length>0&&userPass.length<6 || userPass.length >15){
            pts.innerHTML ="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*密码长度须在6-15之间!";
            valid[1]=false;
            return false;
        }
...
function checkRPass(){
        ...
        //     return false;
        // }
        if(userRPass.length>0&&userRPass.length<6&&userRPass.length>0){
